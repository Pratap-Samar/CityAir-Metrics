    ...
    <div className="dashboard-page">
      ...
      <section className="dashboard-row-1">
        <div className="dashboard-card summary-card">
          <div className="sc-icon-circle cp-aqi-icon">
            <ColorfulAqiIcon size={24} />
          </div>
          <div className="sc-content">
            <div className="sc-title">AVG AQI (India)</div>
            <div className="sc-value">
              {summary?.average_aqi !== null &&
              summary?.average_aqi !== undefined
                ? Math.round(summary.average_aqi)
                : "-"}
            </div>
        ...
        <div className="dashboard-card summary-card">
          <div className="sc-icon-circle cp-temp-icon">
            <ColorfulTemperatureIcon size={24} />
          </div>
          <div className="sc-content">
            <div className="sc-title">AVG TEMPERATURE (India)</div>
            <div className="sc-value">
              {summary?.average_temperature_c !== null &&
              summary?.average_temperature_c !== undefined
                ? `${Math.round(summary.average_temperature_c)}°C`
                : "-"}
            </div>
        ...
        <div className="dashboard-card summary-card">
          <div className="sc-icon-circle">
            <ColorfulBuildingIcon size={24} />
          </div>
          <div className="sc-content">
            <div className="sc-title">CITIES MONITORED</div>
            <div className="sc-value">{summary?.total_cities ?? "-"}</div>
      ...
      <section className="dashboard-row-2">
        <div className="dashboard-card map-card">
          ...
          <div className="map-legend-simple">
            ...
            <div className="legend-item">
              <div className="dot" style={{ backgroundColor: "#facc15" }} />{" "}
              Moderate
            </div>
            <div className="legend-item">
              <div className="dot" style={{ backgroundColor: "#f97316" }} />{" "}
              Unhealthy
            </div>
            <div className="legend-item">
        ...
        <div className="city-panel-container">
          {selectedCity ? (
            ...
            <div
              className="dashboard-card city-panel-card"
              style={{
                height: "100%",
                display: "flex",
                alignItems: "center",
      ...
      <section className="dashboard-row-3">
        <div className="dashboard-card trend-card">
          <div className="trend-header">
            <div className="trend-title">
              AQI Trend &mdash; India (All State Capitals)
            </div>
        ...
        <div className="dashboard-card trend-card">
          <div className="trend-header">
            <div className="trend-title">
              Temperature Trend &mdash; India (All State Capitals)
            </div>
            <div className="trend-toggles">
              <button
